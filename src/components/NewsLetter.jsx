...
const NewsLetter = () => {
  return (
    <>
      <div className="flex md:flex-row flex-col items-start md:items-center justify-between gap-5 text-sm w-full bg-white mt-16 pb-6">
        <div className="max-w-md w-full p-8">
          ...
          <div className="flex items-center gap-4 mt-10">
            <input
              className="py-2 px-3 w-full outline-none focus:border-primary/60 transition max-w-64 border border-gray-500/30 rounded-md"
              type="text"
        ...
        <div className="space-y-4 md:max-w-48">
          <div className="flex items-center gap-3">
            <div className="bg-primary w-max p-2.5 rounded">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
